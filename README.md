![HTB Lightweight (10.10.10.119) Write-up](./screenshots/lightweight.jpeg)
...
1. Open http://10.10.10.119 (default: __port 80__)
   - Landing Page: 
     ...
     ![Landing Page](./screenshots/80_lightweight.png)
...
4. Check why __*/status.php*__ takes a while to load
   ...
   4. Open __*tcpdump.pcap*__ file in __Wireshark__:
      - LDAP __*bindRequest*__:
        ...
        ![LDAP bindRequest](./screenshots/wireshark_bindrequest.png)

      - LDAP __*bindResponse*__:
        
        ![LDAP bindResponse](./screenshots/wireshark_bindresponse.png)
...
## PART 3 : Change User (10.10.13.21 -> ldapuser2)
...
## PART 4 : Change User (ldapuser2 -> ldapuser1)
...
2. Extract contents of __*backup.7z*__:
   ...
   ![Password protected](./screenshots/backup_7z.png)
